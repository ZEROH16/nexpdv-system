...
export type LicenseStatus = "active" | "trial" | "expired" | "blocked" | "cancelled" | "inactive";
export type BuiltInLicensePlan = "OFFLINE" | "CLOUD" | "PRO";
export type LicensePlan = BuiltInLicensePlan | (string & {});
